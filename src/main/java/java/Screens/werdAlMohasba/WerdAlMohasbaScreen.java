...
public class WerdAlMohasbaScreen extends Base {
	 ...
	 */
	/**
	 * This method is to click on info screen and returns WerdAlMohasba_InfoScreen
	 */
	public WerdAlMohasba_InfoScreen clickOnInfoButton() {
		TestUtils.fluentWaitBySecondsToCheckTheClickabilityOfAnAndroidElemnet(1, 60, infoButton_Btn);
		infoButton_Btn.click();
		return new WerdAlMohasba_InfoScreen();
	}
	/**
	 * *********************************************************************************************************************************************
	 */
