...
public class QuranWerd_InfoScreen extends Base {
     ...
     */
    /**
     * This method is to click on pause button and returns QuranWerd_InfoScreen_PopUpScreen
     *
     * @return QuranWerd_InfoScreen_PopUpScreen
     */
    public QuranWerd_InfoScreen_PopUpScreen clickOnPauseButton() {
        TestUtils.fluentWaitBySecondsToCheckTheClickabilityOfAnAndroidElemnet(1, 60, pauseButton_Btn);
        pauseButton_Btn.click();
        return new QuranWerd_InfoScreen_PopUpScreen();
    }
    /**
     * *********************************************************************************************************************************************
     */
    /**
     * This method is to click on delete button and returns QuranWerd_InfoScreen_PopUpScreen
     *
     * @return QuranWerd_InfoScreen_PopUpScreen
     */
    public QuranWerd_InfoScreen_PopUpScreen clickOnDeleteButton() {
