...
public class TechnicalSupport_ContactUsScreen extends Base {
	 ...
	 *
	 * @return TechnicalSupport_ContactUsPurposeScreen
	 */
	public TechnicalSupport_ContactUsPurposeScreen clickOnContactUsPurposeScreenButton() {
		...
		return new TechnicalSupport_ContactUsPurposeScreen();
	}
	/**
	 * *********************************************************************************************************************************************
	 */
